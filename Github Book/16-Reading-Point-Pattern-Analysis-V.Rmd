...
```{r fig.cap= "\\label{fig:edge-effects}Figure 16.1 Edge effects", echo=FALSE}
knitr::include_graphics(rep("Point Pattern Analysis V Figure 1.jpg"))
```
...
```{r fig.cap= "\\label{fig:sampled-pattern}Figure 16.2 Sampled point pattern", echo=FALSE}
knitr::include_graphics(rep("Point Pattern Analysis V Figure 2.jpg"))
```
