---
title: "17 Spatially Continuous Data II"
...
$$
\hat{z}_p = \hat{f}(x_p, y_p) + \hat{\epsilon}_p
$$
The first part of the prediction ($\hat{f}(x_p, y_p)$) is the point estimate of the prediction, whereas the second part ($\hat{\epsilon}_p$) is the random element.
...
![Figure 1. Accuracy and precision](16. Practice - Figure 1.jpg)
