...
```{r}
#converts dataframe to planar point pattern using the defined window "W"
...
```{r}
#The split functions separates without deifining a window. This is a quicker option to get relative results
...
```{r}
#"quadrat.test" generates a quadrat-based test of independence, in this case, for "Pattern 2" called from "PointPatterns.ppp", with a defined quadrat size of 3 by 3 
...
```{r}
#The "Paste" function creates an argumennt for a string of values for "X2", where X2" is the squared sum of the residuals
...
```{r}
# The "density" function computes estimates of kernel density. Here we are creating a Kernel Density estimate using "pp0.ppp" from our dataframe by means of a bandwidth defined by "sigma"
