...
```{r}
Hamilton_CT <- mutate(Hamilton_CT, AreaID = 1:188)
...
map <- ggplot(data = Hamilton_CT) +
  geom_sf(aes(fill = round(POP_DENSITY), AreaID = AreaID)) + 
  scale_fill_distiller(palette = "YlOrRd", direction = 1, guide = FALSE)
