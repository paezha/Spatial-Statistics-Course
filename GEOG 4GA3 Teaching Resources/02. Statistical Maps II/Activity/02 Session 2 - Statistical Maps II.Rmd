---
title: "02 Session 2: Statistical Maps II"
...
1. The objective of this activity is to learn about patterns and processes, including random patterns.
2. You should understand the general approach to retrieve a process from a pattern.
3. You should be able to discuss the importance of discriminating random patterns.
