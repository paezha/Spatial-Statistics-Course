...
In previous practice/session, you learned about different ways to define _proximity_ for area data, about spatial weights matrices, and how spatial weights matrices could be used to calculate spatial moving averages. 
...
A crude rule to make this adjustment is called _Bonferroni correction_. This correction is as follows:
$$
