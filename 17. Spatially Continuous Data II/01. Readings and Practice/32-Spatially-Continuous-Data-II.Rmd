...
# Spatially Continuous Data II {#spatially-continuous-data-ii}
...
In Chapter \@ref(spatially-continuous-data-i) we were introduced to the concept of fields/spatially continuous data. Three different approaches were discussed that can be used to convert a set of observations of a field at discrete locations into a surface, namely tile-based approaches, inverse distance weighting (IDW), and $k$-point means. In this practice, you will learn:
