...
# Select a radius
r <- 10
# Extract observations that are within a radius of `r` from focal point `xy0` (note that sqrt((x - xy0)^2 + (x - xy0)^2) is Pythagora's formula for calculating the distance between two points; if this distance is less than `r`, the point is kept)
df1_simulated %>% 
