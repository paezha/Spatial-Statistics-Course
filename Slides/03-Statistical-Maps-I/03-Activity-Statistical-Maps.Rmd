...
```{r}
ggplot(HamiltonDAs) +
  geom_sf(aes(fill = VAR1), color = "black", alpha = 1, size = .3) +
  scale_fill_fermenter(palette = "Reds") +
  coord_sf() +
  labs(fill = "Variable 1") + 
...
```{r}
ggplot(HamiltonDAs) +
  geom_sf(aes(fill = VAR2), color = "black", alpha = 1, size = .3) +
  scale_fill_fermenter(palette = "Reds") +
  coord_sf() +
  labs(fill = "Variable 2") + 
  theme(panel.background = element_rect(fill = "black"),
        plot.background = element_rect(fill = "black"),
        legend.background = element_rect(fill = "black"),
        text = element_text(color = "white"),
...
```{r}
ggplot(HamiltonDAs) +
  geom_sf(aes(fill = VAR3), color = "black", alpha = 1, size = .3) +
  scale_fill_fermenter(palette = "Reds") +
  coord_sf() +
  labs(fill = "Variable 3") + 
  theme(panel.background = element_rect(fill = "black"),
        plot.background = element_rect(fill = "black"),
        legend.background = element_rect(fill = "black"),
        text = element_text(color = "white"),
...
```{r}
ggplot(HamiltonDAs) +
  geom_sf(aes(fill = VAR4), color = "black", alpha = 1, size = .3) +
  scale_fill_fermenter(palette = "Reds") +
  coord_sf() +
  labs(fill = "Variable 4") + 
  theme(panel.background = element_rect(fill = "black"),
        plot.background = element_rect(fill = "black"),
        legend.background = element_rect(fill = "black"),
        text = element_text(color = "white"),
...
ggsave("variable-4.png")
```

```{r}
ggplot(HamiltonDAs) +
  geom_sf(aes(fill = VAR5), color = "black", alpha = 1, size = .3) +
  scale_fill_fermenter(palette = "Reds") +
  coord_sf() +
  labs(fill = "Variable 5") + 
  theme(panel.background = element_rect(fill = "black"),
        plot.background = element_rect(fill = "black"),
        legend.background = element_rect(fill = "black"),
        text = element_text(color = "white"),
