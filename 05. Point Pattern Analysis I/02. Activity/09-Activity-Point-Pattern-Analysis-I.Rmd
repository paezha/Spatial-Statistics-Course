---
title: "05 Activity 5: Point Pattern Analysis I"
...
In addition to the dataframes, the following `ppp` objects are available:

* `Fast_Food.ppp`
* `Gas_Stands.ppp`
* `Paez_Mart.ppp`

These include the same information, but for your convenience I have converted them to `ppp` for use with `spatstat` functions.
