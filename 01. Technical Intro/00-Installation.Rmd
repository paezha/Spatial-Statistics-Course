...
```{r fig.cap= "\\label{fig:data-analysis-process}Figure 1.1 The process of doing data analysis (from Wickham and Grolemund, 2016)", echo=FALSE}
knitr::include_graphics(rep("Data Analysis - Grolemund and Wickham.png"))
```
...
```{r fig.cap= "\\label{fig:RStudio-IDE}Figure 1.2 The RStudio IDE", echo=FALSE}
knitr::include_graphics(rep("RStudio IDE.png"))
```
