...
```{r fig.cap= "\\label{fig:data-analysis-process}Figure. 1 The process of doing data analysis (from Wickham and Grolemund, 2016)", echo=FALSE}
...
```{r fig.cap= "\\label{fig:RStudio-IDE}Figure 2. The RStudio IDE", echo=FALSE}
