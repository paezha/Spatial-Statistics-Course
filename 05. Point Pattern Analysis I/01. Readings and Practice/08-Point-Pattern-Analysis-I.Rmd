...
#facet_grid is also used in the code below to plot the variety of patterns in the dataframe
...
In the preceding activity, you were asked to generate ideas regarding possible ways of deciding whether a map of events (i.e., a point pattern) is random. In this chaper we will formalize a specific idea to do so, by considering the _intensity_ of the process.
