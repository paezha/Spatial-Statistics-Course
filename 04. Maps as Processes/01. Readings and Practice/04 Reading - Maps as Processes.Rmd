---
title: "04 Maps as Processes: Null Landscapes and Spatial Processes"
...
Random variables can be used to generate purely random maps. These are called _null landscapes_ or _neutral landscapes_ in spatial ecology (see [this](http://www.jstor.org/stable/pdf/3546007.pdf)). 
...
Please visit [app](link) to explore different examples of spatial processes. Notice that some _look_ more random and some _look_ more systematic. At which point do you think it ceases being random?