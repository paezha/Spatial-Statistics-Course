...
A figure illustratates how the function above creates a regression _plane_. First, create a grid of coordinates for plotting:
```{r}
...
kable(cor(cbind(x = df$x, `x^2` = df$x^2, `x^3` = df$x^3, `x^4` = df$x^4)), 
