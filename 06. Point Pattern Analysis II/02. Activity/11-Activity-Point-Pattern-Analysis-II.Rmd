---
title: "05 Session 5: Point Pattern Analysis II"
...
To turn "bear_df" into a ppp: 
```{r}
w <- owin(c(500000, 7000000), c(500000,7000000))
bear.ppp <- as.ppp(bear_df, W=w)
```

If you inspect your workspace, you will see that the following `ppp` object is there:
