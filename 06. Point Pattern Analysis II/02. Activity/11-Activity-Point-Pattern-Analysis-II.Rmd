...
plot(bear.ppp)
plot(split(bear.ppp))
plot(split(bear.ppp)$"Day Time")
plot(split(bear.ppp)$"Night Time")
```

```{r}
q_test <- quadrat.test(split(bear.ppp)$"Day Time", nx = 2, ny = 2)
q_test
plot(q_test)
q2_test <- quadrat.test(split(bear.ppp)$"Night Time", nx = 2, ny = 2)
q2_test
plot(q2_test)
q3_test <- quadrat.test(split(bear.ppp), nx = 2, ny = 2)
q3_test
plot(q3_test)
```

```{r}
kernel_density700 <- density(split(bear.ppp), sigma = 700)
plot(kernel_density700)
kernal_density500 <- density(split(bear.ppp), sigma = 500)
plot(kernal_density500)
```
