...
```{r}
f_all <- Fest(Fast_Food.ppp)
plot(f_all)

f_chicken <- Fest(split(Fast_Food.ppp)$"Chicken", correction = "none")
plot(f_chicken)
f_hamburger <- Fest(split(Fast_Food.ppp)$"Hamburger", correction = "none")
plot(f_hamburger)
f_pizza <- Fest(split(Fast_Food.ppp)$"Pizza", correction = "none")
plot(f_pizza)
f_sub <- Fest(split(Fast_Food.ppp)$"Sub", correction = "none")
plot(f_sub)
```
...
```{r}
k_all <- Kest(Fast_Food.ppp)
plot(k_all)

k_chicken <- Kest(split(Fast_Food.ppp)$"Chicken", correction = "none")
plot(k_chicken)
k_hamburger <- Kest(split(Fast_Food.ppp)$"Hamburger", correction = "none")
plot(k_hamburger)
k_pizza <- Kest(split(Fast_Food.ppp)$"Pizza", correction = "none")
plot(k_pizza)
k_sub <- Kest(split(Fast_Food.ppp)$"Sub", correction = "none")
plot(k_sub)
```
